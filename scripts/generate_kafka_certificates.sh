...
ROOT_DIR="$SCRIPT_DIR/.."
CERT_DIR="$ROOT_DIR/compose/certs"

KEYSTORE_FILENAME="kafka.server.keystore.jks"
VALIDITY_IN_DAYS=3650
DEFAULT_TRUSTSTORE_FILENAME="kafka.server.truststore.jks"
TRUSTSTORE_WORKING_DIRECTORY="$CERT_DIR/truststore"
KEYSTORE_WORKING_DIRECTORY="$CERT_DIR/keystore"
CA_CERT_FILE="ca-cert"
KEYSTORE_SIGN_REQUEST="$CERT_DIR/cert-file"
KEYSTORE_SIGN_REQUEST_SRL="$CERT_DIR/ca-cert.srl"
KEYSTORE_SIGNED_CERT="$CERT_DIR/cert-signed"
KEYSTORE_CRED_FILE="$CERT_DIR/keystore_creds"
SSLKEY_CRED_FILE="$CERT_DIR/sslkey_creds"
TRUSTSTORE_CRED_FILE="$CERT_DIR/truststore_creds"
...
echo
echo "123456a@" > $KEYSTORE_CRED_FILE
echo "123456a@" > $SSLKEY_CRED_FILE
echo "123456a@" > $TRUSTSTORE_CRED_FILE
